...
# from formalgeo.core.engine import (EquationKiller, GeometryPredicateLogicExecutor)
from formalgeo.core.engine_v2 import (EquationKiller, GeometryPredicateLogicExecutor)
